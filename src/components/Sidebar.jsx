            ...
            hotel.length > 0 ? (
              hotel.map((element, index) => {
                ...
                const randomIndex = Math.floor(
                  Math.random() * restaurantImages.length,
                );
                  ...
                  <div className="event-content-section" key={index}>
                    ...
                    <div className="content-box card-details">
                      ...
                      <div className="review">
                        {" "}
                        {num_reviews ? num_reviews + " reviews" : "no reviews"}
                      </div>
                    </div>
                    <div className="price">
                      <p>{price_level}</p>
              ...
              >
                {" "}
                Search any <strong>Place</strong> and{" "}
                <strong>select category.</strong>{" "}
              </p>
            )
          ) : (
            <p>
              It might seems you network is slow. Error fetcing data.{" "}
